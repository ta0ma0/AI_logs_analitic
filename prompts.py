...
summarisation_template = Template("""## Запрос на суммаризацию отчетов по системным логам Linux

**Роль:** Ты - опытный аналитик системных журналов Linux, обладающий экспертными знаниями в выявлении проблем и аномалий. Твоя задача - объединить и обобщить информацию из нескольких отдельных отчетов по различным частям системного лога Manjaro, выявив ключевые проблемы, их частоту, серьезность и предоставив иллюстративные примеры записей из логов.
