...
grep -E -v '(0x000|coredump|snapd|usb|UFW|mtp-probe|rtkit|baloo|NetworkManager|dbus-daemon|telegram|ACPI|gvfsd-trash|CROND|blueman-manager|bluetoothd|dockerd|wpa_supplicant|python3|pulseaudio|dockerd|systemd)' /var/log/daily_log_report_$date.txt > $SCRIPT_DIR/./../data/daily_log_report.txt
